...
class OfficeitemDetails extends StatefulWidget {
  ...
  @override
  State<OfficeitemDetails> createState() => _OfficeItemDetailsState();
}

class _OfficeItemDetailsState extends State<OfficeitemDetails> {
